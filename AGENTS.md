...
- The friction ledger (`data/friction.jsonl`, `features/self-improvement.md`) is on the bot's host disk: ephemeral on Cloudflare Containers (a redeploy starts it over), a volume on Fly/compose. A Durable-Object-backed ledger behind the same seam is the follow-up.
