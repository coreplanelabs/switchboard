...
export interface Env {
  ...
  OPENROUTER_MGMT_KEY?: string; // costs dash (optional): OpenRouter management key for the invoice tie-out, named by providers.openrouter.invoiceKeyEnv
  OPENAI_ADMIN_KEY?: string; // costs dash (optional): OpenAI admin key for the invoice tie-out, named by providers.openai.invoiceKeyEnv
