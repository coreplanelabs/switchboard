...
| 0026 | [A run is a capability profile over three axes, named agents become presets, and a routing stage picks the profile](../decisions/0026-capability-profiles-and-request-routing.md) | Strategy as data + a routing filter in the pipeline; RBAC on the preset, admission boundaries on the axes | proposed | 2026-09-09 |
