...
- [`docs/reference/specs/command-registry.md`](../reference/specs/command-registry.md) — the full behavioral contract, every edge case, every test.
