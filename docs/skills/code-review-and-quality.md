<!--
Vendored reference — checked in verbatim for provenance. Do not edit the body;
re-fetch from source to update.

Source:  https://github.com/addyosmani/agent-skills — skills/code-review-and-quality/SKILL.md
Raw URL: https://raw.githubusercontent.com/addyosmani/agent-skills/main/skills/code-review-and-quality/SKILL.md
Repo:    addyosmani/agent-skills
Fetched: 2026-08-28

Why it's here: Switchboard's review agent (REVIEW_SYSTEM / REVIEW_SYSTEM_RESIDENT
in src/agents/registry.ts) derives its review methodology — the five-axis
framework, the review process, and the severity scheme that shapes its output —
from this skill. The prompt is a distilled adaptation for a per-PR review agent,
not a copy; this file is the full upstream text kept for attribution and so the
distillation can be diffed against its source. See features/agent-review.md.
-->
