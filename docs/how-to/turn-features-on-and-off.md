...
Run exactly the Switchboard you need — a Slack bot with one provider on a laptop, or the full four-Worker deployment — and know, before you change a block of `config.yaml`, what will appear, what will disappear, and what it will cost to run.
