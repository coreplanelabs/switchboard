...
This is the condensed operator runbook. Bringing an installation up from nothing — the profile, the first secrets, the first `deploy all` — is [Deploy](deploy.md); reach for this page for what you actually do day to day.
...
- [Deploy](deploy.md) — the profile, the secrets, the first deploy, and what any other host must provide.
