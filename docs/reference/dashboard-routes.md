...
| `/api/config.clear` | `POST` | `config:write` | Drop every runtime override of a channel (gated), of yourself, or of a thread (gated like the channel); static config.yaml values show through again. |
