...
Mention it in Slack and an agent reviews the PR, ships the fix, or answers the question — on the model you choose, with its tools running where you decide. A deleted branch returns its thread to the default branch.
