...
export const FIELD_HINTS: SampleHints = {
  ...
  only: "memory",
  skip: "sandbox",
  // config.set: per-agent maps keyed by a real agent name and, for the
  // harness, one of the roster's words; a boundary whose machines list names
  // real classes (the generic object sample would not).
  models: { general: "anthropic/general-model" },
  efforts: { general: "low" },
  harness: { general: "opencode" },
