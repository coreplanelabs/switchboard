...
/** The resident's build steps, as the attach and op grafts name them
 *  (`dispatch.workspace.attach.<step>`, `run.command.<step>`). */
const RESIDENT_STEP_NAMES: Readonly<Record<string, string>> = {
