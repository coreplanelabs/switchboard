...
describe("duration ratchet", () => {
  ...
  it("the production file set excludes tests, test helpers, the budgets module and the two ratchets' own files", () => {
  ...
  it("the allowlist matches the tree exactly: no file grew a literal, no listed file has fewer than recorded (regenerate with `npm run clock:gen` when a literal becomes a row)", () => {
