...
// The diff-gated spec review (docs/reference/specs/agent-review.md item 14), one
// text for both review variants: the touched specs are read, never the tree,
// and a contradiction is a finding at minor or above — the severity the review
// loop acts on, so the spec is fixed in the PR or the round is not done. Written
