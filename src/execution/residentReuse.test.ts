...
// run starts from a clean tree at the bound ref's tip. A tree left dirty, or
// on a commit that is neither the tip nor a descendant of it — a binding a
// rebind has since moved onto another branch leaves exactly such a tree — is
// recreated; there is no flag that keeps it.
